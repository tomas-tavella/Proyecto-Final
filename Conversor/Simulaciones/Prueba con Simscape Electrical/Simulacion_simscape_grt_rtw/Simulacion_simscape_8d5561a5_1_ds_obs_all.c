...
int32_T Simulacion_simscape_8d5561a5_1_ds_obs_all(const NeDynamicSystem *sys,
  const NeDynamicSystemInput *t27, NeDsMethodOutput *t28)
{
  PmRealVector out;
  real_T C1_n_v;
  real_T C2_n_v;
  ...
  t0[0UL] = X_idx_7;
  t0[1UL] = -(X_idx_7 * X_idx_7 * 1.0E-9) / -1.0 * 1000.0;
  t0[2UL] = t1;
  t0[3UL] = X_idx_1;
  t0[4UL] = C1_n_v;
  t0[5UL] = 250.0;
  t0[6UL] = X_idx_9;
  t0[7UL] = -(X_idx_9 * X_idx_9 * 1.0E-9) / -1.0 * 1000.0;
  t0[8UL] = t2;
  t0[9UL] = X_idx_3;
  t0[10UL] = C2_n_v;
  t0[11UL] = 250.0;
  t0[12UL] = X_idx_8;
  t0[13UL] = -(X_idx_8 * X_idx_8 * 1.0E-9) / -1.0 * 1000.0;
  t0[14UL] = C1_n_v;
  t0[15UL] = X_idx_0;
  t0[16UL] = 0.0;
  t0[17UL] = C1_n_v;
  t0[18UL] = X_idx_10;
  t0[19UL] = -(X_idx_10 * X_idx_10 * 1.0E-9) / -1.0 * 1000.0;
  t0[20UL] = C2_n_v;
  t0[21UL] = X_idx_2;
  t0[22UL] = 0.0;
  t0[23UL] = C2_n_v;
  t0[24UL] = t4;
  t0[25UL] = -(t4 * t4 * 1.0E-9) / -1.0 * 1000.0;
  t0[26UL] = Cf_p_v;
  t0[27UL] = X_idx_5;
  t0[28UL] = 0.0;
  t0[29UL] = Cf_p_v;
  ...
  t0[68UL] = X_idx_4;
  t0[69UL] = -(X_idx_12 * X_idx_12 * 1.0000000000000002E-12) / -1.0 * 1000.0;
  t0[70UL] = X_idx_12;
  t0[71UL] = Cf_p_v;
  t0[72UL] = X_idx_11;
  t0[73UL] = t9;
  t0[74UL] = X_idx_6;
  t0[75UL] = -(X_idx_15 * X_idx_15 * 1.0000000000000002E-12) / -1.0 * 1000.0;
  t0[76UL] = X_idx_15;
  t0[77UL] = Ideal_Transformer_p1_v;
  t0[78UL] = C1_n_v;
  t0[79UL] = 250.0;
  t0[80UL] = U_idx_0;
  t0[81UL] = C1_n_v;
  ...
  t0[86UL] = Q1_diode_v;
  t0[87UL] = -(t1 * X_idx_18 * 0.001) / -1.0 * 1000.0;
  t0[88UL] = U_idx_0;
  t0[89UL] = X_idx_18;
  t0[90UL] = (-U_idx_0 + 2.0) / -1.0;
  t0[91UL] = C1_n_v;
  t0[92UL] = 250.0;
  t0[93UL] = t1;
  t0[94UL] = 250.0;
  ...
  t0[101UL] = Q2_diode_v;
  t0[102UL] = -(t2 * X_idx_21 * 0.001) / -1.0 * 1000.0;
  t0[103UL] = U_idx_1;
  t0[104UL] = X_idx_21;
  t0[105UL] = (-U_idx_1 + 2.0) / -1.0;
  t0[106UL] = C2_n_v;
  t0[107UL] = 250.0;
  t0[108UL] = t2;
  t0[109UL] = C1_n_v;
  ...
  t0[116UL] = t17;
  t0[117UL] = -(C1_n_v * X_idx_20 * 0.001) / -1.0 * 1000.0;
  t0[118UL] = U_idx_2;
  t0[119UL] = X_idx_20;
  t0[120UL] = (-U_idx_2 + 2.0) / -1.0;
  t0[121UL] = 0.0;
  t0[122UL] = C1_n_v;
  t0[123UL] = C1_n_v;
  t0[124UL] = C2_n_v;
  ...
  t0[131UL] = t20;
  t0[132UL] = -(C2_n_v * X_idx_23 * 0.001) / -1.0 * 1000.0;
  t0[133UL] = U_idx_3;
  t0[134UL] = X_idx_23;
  t0[135UL] = (-U_idx_3 + 2.0) / -1.0;
  t0[136UL] = 0.0;
  t0[137UL] = C2_n_v;
  t0[138UL] = C2_n_v;
  t0[139UL] = t5;
