...
% Estilo viejo
%\fancyfoot[RO]{\xfill[2.5pt]{0.4pt}\Medium[\ {\color{AzulFI_dark}\Bold \thepage}\Medium\ ]}
%\fancyfoot[LE]{\Medium[\ {\color{AzulFI_dark}\Bold \thepage}\Medium\ ]\xfill[2.5pt]{0.4pt}}
%\fancyfoot[C]{}
...
% Estilo nuevo
\fancyfoot[CO]{\SemiBold\rule[-0.2em]{0.8pt}{1.1em}\hspace{0.5em}\color{AzulFI_dark}Tomás Tavella\hspace{0.5em}\normalcolor\rule[-0.2em]{0.8pt}{1.1em}\hspace{-0.05em}\xfill[0.6ex]{0.8pt}\hspace{-0.05em}\rule[-0.2em]{0.8pt}{1.1em}\color{AzulFI_dark}\hspace{0.5em}\thepage\normalcolor\hspace{0.5em}\rule[-0.2em]{0.8pt}{1.1em}}
\fancyfoot[CE]{\SemiBold\rule[-0.2em]{0.8pt}{1.1em}\hspace{0.5em}\color{AzulFI_dark}\thepage\hspace{0.5em}\normalcolor\rule[-0.2em]{0.8pt}{1.1em}\hspace{-0.05em}\xfill[0.6ex]{0.8pt}\hspace{-0.05em}\rule[-0.2em]{0.8pt}{1.1em}\color{AzulFI_dark}\hspace{0.5em}Tomás Tavella\normalcolor\hspace{0.5em}\rule[-0.2em]{0.8pt}{1.1em}}
\fancyhead[R,L]{}
\fancyhead[CO]{\SemiBold\rule[-0.2em]{0.8pt}{1.1em}\hspace{0.5em}\scshape\color{AzulFI_dark}Capítulo \thesection\normalcolor\hspace{0.5em}\rule[-0.2em]{0.8pt}{1.1em}\hspace{-0.05em}\xfill[0.6ex]{0.8pt}\hspace{-0.05em}\rule[-0.2em]{0.8pt}{1.1em}\color{AzulFI_dark}\hspace{0.5em}\rightmark\normalcolor\hspace{0.5em}\rule[-0.2em]{0.8pt}{1.1em}}
\fancyhead[CE]{\SemiBold\rule[-0.2em]{0.8pt}{1.1em}\hspace{0.5em}\scshape\color{AzulFI_dark}\rightmark\normalcolor\hspace{0.5em}\rule[-0.2em]{0.8pt}{1.1em}\hspace{-0.05em}\xfill[0.6ex]{0.8pt}\hspace{-0.05em}\rule[-0.2em]{0.8pt}{1.1em}\color{AzulFI_dark}\hspace{0.5em}Capítulo \thesection\normalcolor\hspace{0.5em}\rule[-0.2em]{0.8pt}{1.1em}}
...
{\normalcolor \tiny\ \Huge\xfill[8pt]{1pt}\rule[-0.2em]{1pt}{1.1em}\ \ \color{AzulFI_dark}\thesection\normalcolor\ \ \rule[-0.2em]{1pt}{1.1em}\xfill[8pt]{1pt}\tiny\ }{0.5em}{}       % Formato del número de seccion
