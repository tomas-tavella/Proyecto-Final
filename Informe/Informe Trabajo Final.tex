...
\titleformat*{\subsection}{\raggedright\color{AzulFI_dark}\scshape\LARGE\Bold}                      % Se agrega raggedright a todos para que no separe palabras en dos cuando tiene que hacer un line break
\titleformat*{\subsubsection}{\raggedright\color{AzulFI_dark}\scshape\Large\SemiBold}
\titleformat*{\paragraph}{\raggedright\color{AzulFI_dark}\large\SemiBold}
\titleformat*{\subparagraph}{\raggedright\large\Medium}
...
\begin{document}
    ...
    \addtocounter{page}{-1}                                         % No cuenta la portada al número de páginas
    \newpage 
