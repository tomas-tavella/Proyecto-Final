...
\usepackage{amsmath}
\usepackage{amsfonts}
\usepackage[labelfont=bf]{caption}              % Para que "Figura x.y" este en bold
\usepackage{graphicx}
...
\titleformat*{\section}{\scshape\huge\centering\bfseries}
...
%\definecolor{GrisTitulo}{rgb}{0.9, 0.9, 0.9}
...
\newcommand{\divider}                           % Macro para divisores horizontales
{
\begin{center}
    \hrulefill
\end{center}
