...
\hyphenation{KiCad}         % Para que no separe KiCad en sílabas
...
\begin{document}
    ...
    \newgeometry{top=2.3cm,bottom=2cm,left=1cm,right=1cm,marginparwidth=1.75cm}
    ...
    \input{Secciones/3 - Diseno de la Plataforma/3 - Diseno de la Plataforma.tex}

    \newpage

    \input{Secciones/4 - Implementacion de la Plataforma/4 - Implementacion de la Plataforma.tex}

    \newpage

    \input{Secciones/5 - Puebas y Ensayos/5 - Pruebas y Ensayos.tex}
