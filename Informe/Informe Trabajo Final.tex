...
\pagestyle{fancy}
\fancyfoot[C]{\rule[1mm]{4cm}{0.2mm} \ \ {\color{AzulFI_dark}\SemiBold \thepage} \ \ \rule[1mm]{4cm}{0.2mm}}
\fancyhead[L]{\color{AzulFI_dark}{\SemiBold \thesection}}
\fancyhead[R]{\scshape{\SemiBold Nombre de Sección}}
...
\begin{document}
    ...
    \input{Secciones/2 - Plataforma de Evaluacion/2 - Plataforma de Evaluacion.tex}
