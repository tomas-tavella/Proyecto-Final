...
yline(24.25,':','24,25 V', 'LineWidth', 1.5, 'Color','#0064A5','FontSize',9,'LabelHorizontalAlignment','right');
ax = gca;
...
f = gcf;
f.Position = [100 100 486 207]      % Posición y tamaño de la ventana
...
ylabel('Tensión [V]', 'FontName', 'Noto Sans SemiBold');
xlabel('Tiempo [μs]', 'FontName', 'Noto Sans SemiBold');
axis([0 50 (min(En1.Vs)-0.1*(abs(max(En1.Vs)-min(En1.Vs)))) (max(En1.Vs)+0.1*(abs(max(En1.Vs)-min(En1.Vs))))]);
f = gcf;
f.Position = [100 100 500 386]      % Posición y tamaño de la ventana
...
yline(23.72,':','23,72 V', 'LineWidth', 1.5, 'Color','#000000','FontSize',9,'LabelHorizontalAlignment','right');
ax = gca;
ax.FontName = 'Noto Sans Medium';
ylabel('Tensión [V]', 'FontName', 'Noto Sans SemiBold');
xlabel('Tiempo [μs]', 'FontName', 'Noto Sans SemiBold');
...
f = gcf;
f.Position = [100 100 500 206]      % Posición y tamaño de la ventana
...
yline(37.09,':','37,09 V', 'LineWidth', 1.5, 'Color','#0064A5','FontSize',9,'LabelHorizontalAlignment','right');
ax = gca;
ax.FontName = 'Noto Sans Medium';
ylabel('Tensión [V]', 'FontName', 'Noto Sans SemiBold');
%xlabel('Tiempo [μs]', 'FontName', 'Noto Sans SemiBold');
...
ylabel('Tensión [V]', 'FontName', 'Noto Sans SemiBold');
xlabel('Tiempo [μs]', 'FontName', 'Noto Sans SemiBold');
axis([0 50 (min(En5.Vs)-0.1*(abs(max(En5.Vs)-min(En5.Vs)))) (max(En5.Vs)+0.1*(abs(max(En5.Vs)-min(En5.Vs))))]);
f = gcf;
f.Position = [100 100 500 386]      % Posición y tamaño de la ventana
...
yline(49.63,':','49,63 V', 'LineWidth', 1.5, 'Color','#0064A5','FontSize',9,'LabelHorizontalAlignment','right');
ax = gca;
ax.FontName = 'Noto Sans Medium';
ylabel('Tensión [V]', 'FontName', 'Noto Sans SemiBold');
%xlabel('Tiempo [μs]', 'FontName', 'Noto Sans SemiBold');
...
ylabel('Tensión [V]', 'FontName', 'Noto Sans SemiBold');
xlabel('Tiempo [μs]', 'FontName', 'Noto Sans SemiBold');
axis([0 50 (min(En7.Vs)-0.1*(abs(max(En7.Vs)-min(En7.Vs)))) (max(En7.Vs)+0.1*(abs(max(En7.Vs)-min(En7.Vs))))]);
f = gcf;
f.Position = [100 100 500 386]      % Posición y tamaño de la ventana
...
yline(47.63,':','47,63 V', 'LineWidth', 1.5, 'Color','#000000','FontSize',9,'LabelHorizontalAlignment','right');
ax = gca;
ax.FontName = 'Noto Sans Medium';
ylabel('Tensión [V]', 'FontName', 'Noto Sans SemiBold');
xlabel('Tiempo [μs]', 'FontName', 'Noto Sans SemiBold');
...
yline(27.95,':','27,95 V', 'LineWidth', 1.5, 'Color','#000000','FontSize',9,'LabelHorizontalAlignment','right');
ax = gca;
ax.FontName = 'Noto Sans Medium';
ylabel('Tensión [V]', 'FontName', 'Noto Sans SemiBold');
xlabel('Tiempo [μs]', 'FontName', 'Noto Sans SemiBold');
