...
Esta tipo particular de convertidor aislado es el que se utiliza en la plataforma en estudio. Se va a obtener su circuito partiendo del convertidor forward de dos llaves de la figura \ref{forward_doubleended}, detallando sus ventajas y desventajas. Luego se va a desarrollar un modelo matemático para representarlo y se explicará la forma de controlarlo mediante el método \textit{phase-shift}.\\
