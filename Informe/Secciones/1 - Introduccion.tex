...
En particular, este trabajo se enfoca en el estudio, diseño, implementación y validación de una plataforma experimental para la evaluación del Módulo de Celdas de Combustible (figura \ref{diag_plataforma}) para Sistemas Híbridos de Generación de Energía. Esta plataforma se compone de cuatro partes principales:
