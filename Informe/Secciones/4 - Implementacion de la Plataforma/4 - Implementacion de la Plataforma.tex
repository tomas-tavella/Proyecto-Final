...
\Large\scshape
\begin{center}
    {\Medium Implementación del sistema completo en una\\ placa de circuito impreso}
\end{center}
\normalfont
%\normalsize
...
\input{Secciones/4 - Implementacion de la Plataforma/4.1 - Diseno de PCB.tex}

\newpage

\input{Secciones/4 - Implementacion de la Plataforma/4.2 - Soldado de Componentes.tex}

\newpage

\input{Secciones/4 - Implementacion de la Plataforma/4.3 - Contratiempos.tex}

\newpage

\input{Secciones/4 - Implementacion de la Plataforma/4.4 - Resumen.tex}
