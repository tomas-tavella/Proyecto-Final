...
\begin{itemize}
    ...
    \item Convertidor CC-CC Conmutado
...
\input{Secciones/2 - Plataforma de Evaluacion/2.1 - Celdas de Combustible.tex}

\input{Secciones/2 - Plataforma de Evaluacion/2.2 - Convertidor CC-CC Conmutado.tex}